...
class Deck:                                       ##instance 없이 쓰는 static method로 Deck.make_deck()
    ...
    # def dealer_auto_hit (self, cards)
...
while True :
    ...
    if invite == 'Yes' :
        ...
        player_received = player.pop_card()
        dealer_received = dealer.pop_card()
        
        print("P>>>", player_received)
        print("D>>>", dealer_received[0], "[]")
